...
import 'package:learn/utilities/dialogues/generics/get_arguments.dart';
import 'package:learn/services/cloud/cloud_note.dart';
import 'package:learn/services/cloud/firebase_cloud_storage.dart';
import 'package:learn/utilities/dialogues/cannot_share_empty_note_dialouge.dart';
...
class _CreateUpdateNoteViewState extends State<CreateUpdateNoteView> {
  ...
  Future<CloudNote> createOrGetExistingNote(BuildContext context) async {
    ...
    final newNote = await _notesService.createNewNotes(
      ownerUserId: userId,
    );
    _note = newNote;
    return newNote;
